...
public class MetadataController : ControllerBase
{
    ...
    {
        var standardCountries = new List<string> { "India", "USA", "UK", "Australia", "Canada", "Singapore", "Malaysia", "UAE", "Thailand", "Maldives", "Sri Lanka", "France", "Germany", "Italy", "Switzerland", "Japan" };
