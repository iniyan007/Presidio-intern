...
public class WishlistServiceTests
{
    ...
    public async Task GetUserWishlistsAsync_ReturnsOrderedMappedList()
    {
        ...
        var packageSummary1 = new PackageSummaryResponse(package1.Id, Guid.NewGuid(), "Company", "Pkg 1", "Type", "Published", "Dest 1", "Country", 1, 1, 5, 10, null, 100, 10, null, null, 20);
        var packageSummary3 = new PackageSummaryResponse(package3.Id, Guid.NewGuid(), "Company", "Pkg 3", "Type", "Published", "Dest 3", "Country", 1, 1, 5, 10, null, 100, 10, null, null, 20);
