...
namespace backend.Migrations
{
    ...
    [Migration("20260427114124_InitialNormalizedSchema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.BusRoute", b =>
                {
                    b.HasOne("backend.Models.City", "DestinationCity")
                        .WithMany("RoutesAsDestination")
                        .HasForeignKey("DestinationCityId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("backend.Models.City", "SourceCity")
                        .WithMany("RoutesAsSource")
